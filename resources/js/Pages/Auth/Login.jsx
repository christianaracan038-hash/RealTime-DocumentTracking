...
/*
 * Sign-in form. It sits on the blue card in GuestLayout, so everything
 * here is styled for a blue ground: white text, white fields, and the
...
function FieldError({ message }) {
    ...
    return (
        <p className="mt-2 flex items-start gap-2 rounded-lg bg-white/15 px-3 py-2 text-sm font-medium text-white">
            ...
            <form onSubmit={submit} className="mt-8 space-y-5">
                ...
                <label className="flex items-center gap-3 py-1">
                    <input
                        ...
                        className="h-5 w-5 rounded border-white/40 bg-white/10 text-accent-400 focus:ring-accent-400"
                    />
