 ...
 *   accent     the primary action when the surface is blue or navy.
 */
...
const VARIANTS = {
    ...
    /*
     * For a button sitting on blue or navy, where the brand blue would
     * vanish. The attention yellow with navy text - the one thing to
     * press on that surface.
     */
